    ...
    <div className="flex gap-4 flex-col">
      ...
      <div>
        <ButtonGroup {...args}>
          ...
          <Button icon="circle-arrow-out-down-right" variant="outline">
            Button 2
          </Button>
          <Button icon="air-vent" variant="outline">
            Button 3
          </Button>
          <Button icon="airplay" variant="outline">
            Button 4
          </Button>
        </ButtonGroup>
      </div>
      ...
      <div>
        <ButtonGroup {...args}>
          <Button variant="outline">Button 1</Button>
          <Button variant="outline" icon="ellipsis-vertical" />
        </ButtonGroup>
      </div>
    </div>
  ),
